...
class RougeScorer(scoring.BaseScorer):
  ...
  def __init__(self, rouge_types, use_stemmer=False, stopwords=None):
  ...
  def score(self, target, prediction):
    ...
    target_tokens = tokenize.tokenize(target, self._stemmer, self._stopwords)
    prediction_tokens = tokenize.tokenize(prediction, self._stemmer, self._stopwords)
    result = {}
