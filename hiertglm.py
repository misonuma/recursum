...
from seq2seq import encode_inputs, encode_latents_gauss, encode_nhdp_probs_topic_posterior, decode_output_logits_flat, decode_output_sample_flat, decode_beam_output_token_idxs
...
class HierarchicalTopicGuidedLanguageModel():
