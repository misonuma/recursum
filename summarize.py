        ...
        for topk_topic_arg in topk_topic_args:
            ...
            if topk_topic_index is not None:
                ...
                if topk_topic_idx in tree_idxs:
                    child_indices = [topic_idxs.index(child_idx) for child_idx in tree_idxs[topk_topic_idx]]
                    new_candidate_topic_indices_list += [candidate_topic_indices + child_indices]
                else:
...
#         candidate_topic_indices_list = new_candidate_topic_indices_list
        candidate_topic_indices_list = [[i for i in new_candidate_topic_indices if len(topic_sents[i].split()) > truncate]
