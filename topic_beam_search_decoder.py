...
#         super(BeamSearchDecoder, self).__init__(
        ...
        self._memory_idxs = memory_idxs
#         self._memory_idxs = array_ops.tile(
#                 array_ops.expand_dims(self._memory_idxs, 1), [1, self._beam_width, 1])
        
        self.latents_input = latents_input
    ...
    def step(self, time, inputs, state, name=None):
        ...
        with ops.name_scope(name, "BeamSearchDecoderStep", (time, inputs, state)):
            ...
            if self.latents_input is not None:
                inputs = array_ops.concat([inputs, self.latents_input], 1)
            ...
            if self._pointer_layer is not None:
                cell_outputs = self._pointer_layer(cell_outputs, next_cell_state, self._memory_idxs)
